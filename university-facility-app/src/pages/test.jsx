...
const FacilityDetails1 = () => {
  ...
  const facilityLat = 6.796430; // Replace with actual coordinates
  const facilityLng = 79.900093;
      ...
      <InfoGrid>
        ...
        <InfoCard>
          ...
          <MapContainer>
            ...
            <br /> */}
           <FacilityLiveMap  lat={facilityLat} lng={facilityLng} zoom={17} />
          </MapContainer>
...
export default FacilityDetails1;